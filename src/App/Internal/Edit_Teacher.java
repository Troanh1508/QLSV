...
public class Edit_Teacher extends javax.swing.JInternalFrame {
    ...
    private boolean check_Mail(String email) {
        ...
        List<tbl_Teacher> LT_check = TC.select(" WHERE Email != N'" + teacher.getEmail() + "'");
        boolean check = false;
        for (tbl_Teacher t : LT_check) {
    ...
    private boolean check_Phone(String phone) {
        Teacher_Controller SC = new Teacher_Controller(conn);
        List<tbl_Teacher> LT_check = SC.select(" WHERE Phone != N'" + teacher.getPhone()+ "'");
        boolean check = false;
        for (tbl_Teacher t : LT_check) {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Edit information teacher");
        setToolTipText("");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (name.length() == 0 || Phone.length() == 0 || Email.length() == 0 || Address.length() == 0 || DOB.length() == 0) {
            JOptionPane.showMessageDialog(null, "Vui lòng nhập đầy đủ thông tin để tiến hành thay đổi");
        } else if (ev.isNotValidEmail(Email)) {
            ...
            int choose = JOptionPane.showConfirmDialog(null, "Bạn có chắc sẽ cập nhập giảng viên với các dữ liệu trên?");
