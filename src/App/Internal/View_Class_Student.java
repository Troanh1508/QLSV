...
public class View_Class_Student extends javax.swing.JInternalFrame {
    ...
    public View_Class_Student(tbl_Class c, Connection conn, View_Mark_Student v) {
        ...
        this.v = v;
        initComponents();
        jLabel.setText("Danh Sách Sinh Viên Lớp " + c.getName());
    ...
    private void loadTable() {
        ...
        for (int i = 0; i < LS.size(); i++){
            ...
            switch (s.getGender()) {
                case 1: {
                    Object o[] = {
                        (i + 1), s.getMasv(), s.getName(), s.getEmail(), s.getAddress(), "Nam", DOB
                    };
                    dtm.addRow(o);
                    break;
                }
                case 2: {
                    Object o[] = {
                        (i + 1), s.getMasv(), s.getName(), s.getEmail(), s.getAddress(), "Nữ", DOB
                    };
                    dtm.addRow(o);
                    break;
                }
                default: {
                    Object o[] = {
                        (i + 1), s.getMasv(), s.getName(), s.getEmail(), s.getAddress(), "Chưa xác định", DOB
                    };
                    dtm.addRow(o);
                    break;
                }
    ...
    private void initComponents() {
        ...
        jLabel.setText("List student of class");
