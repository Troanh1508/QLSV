 ...
 * @author Troanh
 */
public class Panel_Class extends javax.swing.JPanel implements View_Class_Student.View_Mark_Student {
    ...
    public Panel_Class(Connection conn, tbl_Teacher acc) {
        ...
        this.acc = acc;
        initComponents();
        Save_Edit_Class.setVisible(false);
        End_Edit_Class.setVisible(false);
        getCourse();
        set_Cbx_Course();
        load_Teacher();
    ...
    private void initComponents() {
        ...
        End_Edit_Class = new javax.swing.JButton();
        Save_Edit_Class = new javax.swing.JButton();
        Delete_Class = new javax.swing.JButton();
        ExportClass = new javax.swing.JButton();
        ...
        View_Student.setLabel("Xem Danh Sách Sinh Viên");
        ...
        Name_Class.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Name_ClassActionPerformed(evt);
            }
        });

        jLabel13.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        jLabel13.setText("Khoá:");

        jLabel14.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        jLabel14.setText("GVCN:");
        ...
        Cbx_Class_Teacher.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Cbx_Class_TeacherActionPerformed(evt);
            }
        });
        ...
        End_Edit_Class.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        End_Edit_Class.setText("Cancel");
        End_Edit_Class.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                End_Edit_ClassActionPerformed(evt);
            }
        });

        Save_Edit_Class.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        Save_Edit_Class.setIcon(new javax.swing.ImageIcon(getClass().getResource("/App/image/edit.png"))); // NOI18N
        Save_Edit_Class.setText("Save");
        Save_Edit_Class.setToolTipText("");
        Save_Edit_Class.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Save_Edit_ClassActionPerformed(evt);
            }
        });

        Delete_Class.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        Delete_Class.setIcon(new javax.swing.ImageIcon(getClass().getResource("/App/image/delete.png"))); // NOI18N
        Delete_Class.setText("Xoá lớp");
        Delete_Class.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Delete_ClassActionPerformed(evt);
            }
        });

        ExportClass.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        ExportClass.setIcon(new javax.swing.ImageIcon(getClass().getResource("/App/image/excel.png"))); // NOI18N
        ExportClass.setText("Xuất Excel");
        ExportClass.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ExportClassActionPerformed(evt);
            }
        });
        ...
        jPanel27Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel27Layout.createSequentialGroup()
                ...
                .addGroup(jPanel27Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel27Layout.createSequentialGroup()
                        .addComponent(End_Edit_Class, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(Save_Edit_Class, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel27Layout.createSequentialGroup()
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel27Layout.createSequentialGroup()
                        .addComponent(ExportClass, javax.swing.GroupLayout.DEFAULT_SIZE, 143, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(Delete_Class, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanel27Layout.setVerticalGroup(
            ...
            .addGroup(jPanel27Layout.createSequentialGroup()
                ...
                .addGroup(jPanel27Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(Save_Edit_Class, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(End_Edit_Class, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel27Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Delete_Class)
                    .addComponent(ExportClass))
    ...
    private void Search_ClassActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Search_ClassActionPerformed
        String search = Class_Search.getText();
        int course_id = LCA.get(Cbx_Class.getSelectedIndex()).getId();
        if (acc.getRole_ID() == 1) {
            load_Class_Table("WHERE Name LIKE N'%" + search + "%' AND Course_ID = " + course_id);
        } else {
            load_Class_Table("WHERE Name LIKE N'%" + search + "%' AND Course_ID = " + course_id + " AND Teacher_ID = " + acc.getID());
        }
    ...
    private void End_Edit_ClassActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_End_Edit_ClassActionPerformed
        edit_class = null;
        ...
        Delete_Class.setVisible(true);
    }//GEN-LAST:event_End_Edit_ClassActionPerformed

    private void Save_Edit_ClassActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Save_Edit_ClassActionPerformed
    ...
    }//GEN-LAST:event_Save_Edit_ClassActionPerformed
    ...
    private void Edit_ClassActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Edit_ClassActionPerformed
        ...
        Cbx_Class_Teacher.setSelectedIndex(0);
        Save_Edit_Class.setVisible(true);
        End_Edit_Class.setVisible(true);
        Add_New_Class.setVisible(false);
        Refesh_add_Class.setVisible(false);
        Delete_Class.setVisible(false);
        } else JOptionPane.showMessageDialog(null, "Bạn không đủ quyền hạn");
    ...
    private void Name_ClassActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Name_ClassActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Name_ClassActionPerformed

    private void Cbx_Class_TeacherActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Cbx_Class_TeacherActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Cbx_Class_TeacherActionPerformed

    private void Delete_ClassActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Delete_ClassActionPerformed
        if (acc.getRole_ID() > 1) {
            JOptionPane.showMessageDialog(null, "Bạn không đủ quyền hạn để thực hiện");
        } else {
            tbl_Class classDelete = LC.get(Class_Table.getSelectedRow());
            int id = classDelete.getId();
            Student_Controller SC = new Student_Controller(conn);
            LS = SC.select(" WHERE Class_ID = " + classDelete.getId());
            if (LS.size() > 0){
                JOptionPane.showMessageDialog(null, "Chỉ được xoá lớp không có sinh viên nào!");
            }
            else {
                int deleteItem = JOptionPane.showConfirmDialog(null,"Bạn có chắc muốn xoá lớp?", "Warning",JOptionPane.YES_NO_OPTION);
    ...
    }//GEN-LAST:event_Delete_ClassActionPerformed

    private void ExportClassActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExportClassActionPerformed
        try{
        ...
        if (saveFile != null) {
            ...
            Sheet sheet = wb.createSheet("Danh sách lớp");
            
            Row rowCol = sheet.createRow(0);
            for (int i=0; i<Class_Table.getColumnCount();i++) {
                Cell cell = rowCol.createCell(i);
                cell.setCellValue(Class_Table.getColumnName(i));
            }
            for (int j=0; j<Class_Table.getRowCount();j++) {
                Row row = sheet.createRow(j+1);
                for (int k=0; k<Class_Table.getColumnCount();k++) {
                    Cell cell = row.createCell(k);
                    if(Class_Table.getValueAt(j, k) != null) {
                        cell.setCellValue(Class_Table.getValueAt(j, k).toString());
                    }
                }
            }
    ...
    }//GEN-LAST:event_ExportClassActionPerformed
    ...
    private javax.swing.JButton End_Edit_Class;
    private javax.swing.JButton ExportClass;
    ...
    private javax.swing.JButton Save_Edit_Class;
