...
public class Panel_Account extends javax.swing.JPanel {
    ...
    private boolean check_Mail(String email) {
        ...
        List<tbl_Teacher> LT_check = TC.select(" WHERE Email != N'" + acc.getEmail() + "'");
        boolean check = false;
    ...
    private boolean check_Phone(String phone) {
        ...
        List<tbl_Teacher> LT_check = SC.select(" WHERE Phone != N'" + acc.getPhone()+ "'");
        boolean check = false;
        for (tbl_Teacher t : LT_check) {
    ...
    private void initComponents() {
        ...
        Update.setFont(new java.awt.Font("Arial", 0, 15)); // NOI18N
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
        ...
        if(name.length() == 0 || mail.length() == 0 || phone.length() == 0 || address.length() == 0 || pass.length() == 0 ){
            JOptionPane.showMessageDialog(null, "Vui lòng nhập đầu đủ các trường");
            ...
            if (TC.update(acc_edit)) {
                ...
                JOptionPane.showMessageDialog(null, "Đã có lỗi xảy ra, vui lòng kiểm tra lại SĐT và Email");
            }
        }
